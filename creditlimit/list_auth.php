...
<div class="col-md-12" id="header_wrapper">
	<h4>გთხოვთ მონიშნოთ სასურველი სტრიქონი და დააჭიროთ ღილაკს " დათვალიერება "</h4>
</div>
<Div class="col-md-12" id="middle">
	<form name="frmUser" method="post" action="">
		...
		<div class="col-md-12">
			<input type="button"class="btn btn-primary" name="update" value="დათვალიერება" onClick="setUpdateAction2();" />
		</div>
		</form>
